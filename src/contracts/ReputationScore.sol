...
// File: https://github.com/codingwithmanny/polygonid-on-chain-verification/blob/main/contracts/interfaces/ICircuitValidator.sol
...
// File: https://github.com/codingwithmanny/polygonid-on-chain-verification/blob/main/contracts/interfaces/IZKPVerifier.sol
...
// File: https://github.com/codingwithmanny/polygonid-on-chain-verification/blob/main/contracts/verifiers/ZKPVerifier.sol
...
// File: https://github.com/codingwithmanny/polygonid-on-chain-verification/blob/main/contracts/lib/GenesisUtils.sol
...
// Main Contract
// ========================================================
contract ReputationScore is  ZKPVerifier {
    // Variables
    uint64 public constant TWITTER_CLAIM_ID = 1;
    uint64 public constant GOOGLE_CLAIM_ID = 2;
    uint64 public constant GITHUB_CLAIM_ID = 3;
    uint64 public constant INSTAGRAM_CLAIM_ID = 4;
    uint64 public constant LINKEDIN_CLAIM_ID = 5;
    uint64 public constant DISCORD_CLAIM_ID = 6;
    uint64 public constant LENS_CLAIM_ID = 7;
    uint64 public constant MATIC_CLAIM_ID01 = 8;
    uint64 public constant MATIC_CLAIM_ID02 = 9;
    uint64 public constant MATIC_CLAIM_ID03 = 10;
    uint64 public constant UD_CLAIM_ID03 = 11;
    uint64 public constant NFT_CLAIM_ID03 = 12;
  
    mapping(uint256 => address) public idToAddress;
    mapping(address => uint256) public addressToId;
    mapping(address => uint256) public scoreOf;
    mapping(uint256 => uint256) public claimScore;

    /**
     * @dev constructor
     */
    constructor() {
        claimScore[TWITTER_CLAIM_ID] = 1;
        claimScore[GOOGLE_CLAIM_ID] = 1;
        claimScore[GITHUB_CLAIM_ID] = 1;
        claimScore[INSTAGRAM_CLAIM_ID] = 1;
        claimScore[LINKEDIN_CLAIM_ID] = 1;
        claimScore[DISCORD_CLAIM_ID] = 1;
        claimScore[LENS_CLAIM_ID] = 2;
        claimScore[MATIC_CLAIM_ID01] = 2;
        claimScore[MATIC_CLAIM_ID02] = 3;
        claimScore[MATIC_CLAIM_ID03] = 5;
        claimScore[UD_CLAIM_ID03] = 2;
        claimScore[NFT_CLAIM_ID03] = 2;
    }
    ...
    function _afterProofSubmit(
        ...
        if (idToAddress[id] == address(0)) {
            scoreOf[_msgSender()] = scoreOf[_msgSender()] + claimScore[requestId];
